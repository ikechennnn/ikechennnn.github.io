...
// map on the bottom right cornor
...
d3.csv("../data/historico.csv", function(data) {
  d3.json("../data/Provincias.json", function(json) {
    d3.json("../data/canarian.json", function(can) {
      ...
      // make connection between dataset
      ...
      // interactive map information panel
      ...
      // information update on the top left cornor and fill of the map
